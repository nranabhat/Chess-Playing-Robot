...
cmd[0] = np.array([random.randint(350,650), random.randint(2350,2650)])
deg[1] = np.array([random.randint(-40,-30), random.randint(-170,-155)])
cmd[1] = np.array([random.randint(900,1100), random.randint(2350,2650)])
deg[2] = np.array([random.randint(-15,0), random.randint(145,165)])
cmd[2] = np.array([random.randint(2350,2650), random.randint(900,1100)])
deg[3] = np.array([random.randint(-105,-75), random.randint(75,105)])
cmd[3] = np.array([random.randint(350,650), random.randint(2350,2650)])
deg[4] = np.array([random.randint(-105,-75), random.randint(75,105)])
cmd[4] = np.array([random.randint(2350,2650), random.randint(350,650)])
deg[5] = np.array([random.randint(-105,-75), random.randint(75,105)])
cmd[5] = np.array([random.randint(350,650), random.randint(2350,2650)])
deg[6] = np.array([random.randint(0,10), random.randint(80,90)])
cmd[6] = np.array([random.randint(0,100), random.randint(900,1000)])
